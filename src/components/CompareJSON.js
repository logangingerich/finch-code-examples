  ...
  const deepCompareJSON = () => {
    ...
    try {
      ...
      for (const id in dict1) {
        if (dict2[id]) {
          const diff = deepDiff(dict1[id], dict2[id]);
...
[
  ...
  {
    "id": "1a15a2e7-0565-4862-bd3d-394cc719a7de",
    "first_name": "Logan",
    "middle_name": "Paul",
    "last_name": "Gingerich",
    "manager": {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <textarea
            ...
            rows="5"
            cols="40"
            placeholder="Paste your first /directory JSON output here..."
            value={jsonData1}
      ...
      <br />
        ...
        <textarea
            ...
            rows="5"
            cols="40"
            placeholder="Paste your second /directory JSON output here..."
            value={jsonData2}
    ...
    <button className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" onClick={deepCompareJSON}>Calculate</button>
      <br />
      {comparison !== null && (
        <div>
        ...
        <div>
          ...
          <div className="max-w mx-auto mt-6 bg-gray-900 rounded-lg overflow-hidden">
            <div className="p-4">
                ...
                <span className="text-gray-200 text-xl font-bold">/directory JSON Example 1</span>
      ...
      <p className="mt-6 text-lg leading-8 text-gray-600">
        Try this example JSON array from Finch's /directory endpoint:
          ...
          <div className="max-w mx-auto mt-6 bg-gray-900 rounded-lg overflow-hidden">
            <div className="p-4">
                <div className="flex items-center justify-between">
                <span className="text-gray-200 text-xl font-bold">/directory JSON Example 2</span>
